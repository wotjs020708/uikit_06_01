...
class ViewController: UIViewController {
    ...
    func showMenu(sourceView: UIView) {
        ...
        alert.addAction(UIAlertAction(title: "Submenu", style: .default, handler: { [weak self] _ in self?.showSubmenu(sourceView: sourceView) }))
    ...
    func showSubmenu(sourceView: UIView) {
        ...
        submenuAlert.addAction(UIAlertAction(title: "Paste Format", style: .default, handler: {
            _ in self.showMessage("Paste Format chosen")
        }))
